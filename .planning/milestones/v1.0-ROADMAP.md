...
- [x] 03-04-PLAN.md -- Page wiring, hero CTA update, UI integration tests, visual verification
**UI hint**: yes
...
- [x] 05-03-PLAN.md -- Scroll-speed-adaptive animations + DNS repoint verification checkpoint
**UI hint**: yes
